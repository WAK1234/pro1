  ...
  return (
    <>
      ...
      <div className={"flex flex-row"}>
        <div
          className={
            "bg-[#79cce6] h-screen w-2/5 flex flex-row rounded-tl-3xl rounded-bl-3xl"
          }
        >
          <div className={"mx-0"}>
        ...
        <div className="flex flex-col  w-full  bg-white  rounded-tr-3xl rounded-br-3xl">
          <div className="mx-auto mt-20">
            ...
            >
              <i class="fa-brands fa-google custom-google-icon"></i>
              <span class="text-[blackcd] ml-2">Sign Up With google</span>
            </button>
